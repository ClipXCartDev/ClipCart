...
class _PlansScreenState extends State<PlansScreen> {
        ...
        children: [
          ...
          Container(
            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              Container(
                width: 52, height: 52,
                decoration: BoxDecoration(gradient: const LinearGradient(colors: [Color(0xFFFFC400), Color(0xFF12B886)]), borderRadius: BorderRadius.circular(14)),
  ...
  Widget _planCard(Plan p, {bool popular = false}) {
    return Container(
      ...
      decoration: BoxDecoration(
        gradient: popular ? const LinearGradient(colors: [Color(0xFF12B886), Color(0xFF0E9E6E)]) : null,
            ...
            Row(children: [
              ...
              if (popular)
                Container(
                  ...
                  decoration: BoxDecoration(gradient: const LinearGradient(colors: [Color(0xFF12B886), Color(0xFF0E9E6E)]), borderRadius: BorderRadius.circular(20)),
